...
\emph{\href{/research/\#varieties}{The Chance of Salvation: A History of 
    Conversion in America}} (Harvard University Press, under contract)

\emph{\href{http://dh-r.lincolnmullen.com/}{Computational Historical Thinking: 
  With Applications in R}} (book manuscript): \url{http://lincolnmullen.com/projects/dh-r/}

Kellen Funk and Lincoln Mullen, ``The Spine of American Legal Practice'' (journal 
article)
